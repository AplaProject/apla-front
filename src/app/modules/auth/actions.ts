...
export const loginAccount = actionCreator.async<string, { memberName: string, context: IAccountContext, privateKey: string, publicKey: string, session: ISession }, string>('LOGIN_ACCOUNT');
